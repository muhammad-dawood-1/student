...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            $_SESSION['role'] = 'admin'; // Still keep 'admin' as the primary role for access checks
            $_SESSION['admin_role'] = $user['role']; // Store the specific admin role (superadmin/admin)
